...
const IMPERIAL_SEEDS: DressSeed[] = [
  {
    ...
    images: [
flat('alma_front.jpg'), flat('alma_back.jpg'), flat('alma_detail.jpg'),
flat('alma_back.jpg'),
...
p('IMPERIAL', 'Elia', 'IMG_5415.jpg'),
  ...
  },
  {
    ...
    images: [
flat('elise_front.jpg'), flat('elise_side.jpg'), flat('elise_back.jpg'), flat('elise_detail.jpg'),
flat('elise_side.jpg'),
flat('elise_back.jpg'),
...
p('IMPERIAL', 'Ivory Grace', 'f202fbc6-6dd7-442b-8121-0cc159e5ff40.JPG'),
  ...
  },
  {
    ...
    images: [
p('IMPERIAL', 'Lumiere', 'IMG_5439.jpg'),
],
...
p('ANNA', 'Anastea', 'C5E124D3-D23F-46C6-9FFF-B48DBC1B5C58.PNG'),
  ...
  },
  {
    ...
    images: [
p('ANNA', 'Anatolia', 'IMG_5851.jpg'), p('ANNA', 'Anatolia', 'IMG_5855.jpg'),
...
p('MAYRA', 'Miracle', 'IMG_5729.jpg'),
  ...
  },
  {
    ...
    images: [
p('MAYRA', 'Roze', 'IMG_5735.jpg'), p('MAYRA', 'Roze', 'IMG_5736.jpg'),
