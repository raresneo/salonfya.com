...
const dresses = {
    'Anais': { has_face: true },
    'Anamara': { has_face: false },
    'Anamaria': { has_face: false },
    'Anaria': { has_face: true },
    'Anastasia': { has_face: false },
    'Anastea': { has_face: false },
    'Anatolia': { has_face: true },
    'Anavelle': { has_face: false },
    'Anelie': { has_face: true },
    'Annabelle': { has_face: false },
    'Annador': { has_face: true },
    'Annette': { has_face: true },
    'Just Anna': { has_face: true },
};
