...
const dresses = {
    'Adania': { has_face: true },
    'Celina': { has_face: true },
    'Desideria': { has_face: true },
    'Elvira': { has_face: true },
    'Grazia': { has_face: true },
    'Isadora': { has_face: true },
    'Luminia': { has_face: true },
    'Miracle': { has_face: true },
    'Roze': { has_face: true },
    'Snow': { has_face: false },
    'Tania': { has_face: true },
    'Taniana': { has_face: true },
};
